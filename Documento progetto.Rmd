...
top5goalfatti <- filter(dfRmuovimento,
                        ...
                        Nazionalità == "Belgio"| Nazionalità == "Olanda" |
                        Nazionalità == "Svizzera")
top5goalfatti$Nazionalità <- factor(top5goalfatti$Nazionalità,    
                         levels = c("Danimarca", "Italia", "Inghilterra", "Spagna", "Belgio", "Olanda", "Svizzera"))
...
Come possiamo vedere l'attacco danese è stato il più prolifico anche grazie ad uno delle maggiori quantità di tiri effettuati, il reparto offensivo italiano è stato invece il più propenso a tirare in porta ma non è riuscito a capitalizzare molte di queste occasioni. Inoltre possiamo notare anche in questo caso una vicinanza tra i raprti offensivi di Spagna, Danimarca ed Italia mentre per quanto riguarda l'altra semifinalista, l'Inghilterra, ha sfruttato molto di più il minor numero di tiri tentati.

### Conclusione finale

Come abbiamo visto in questa analisi sul campionato europeo di calcio "Euro 2020". giocatosi la scorsa estate, i dati possono avere una grande importanza anche in ambito calcistico e sportivo tant'è che sempre di più società ci stanno facendo affidamento investendo in personale competente, come match analist e data scientist, per capire come migliorare le prestazione della propria squadra. Il motivo principale che mi ha spinto ad analizzare brevemente questa competizione sta nel provare a guardarla da un'altra prospettiva incentrandosi principalmente sul contenuto e sulla prestazione offerta della nazionali sul campo rispetto al solo risultato sportivo ottenuto.
